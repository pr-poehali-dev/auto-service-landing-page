  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur border-b border-border">
        <div
          className="flex items-center justify-between px-3 sm:px-4 lg:px-6 text-[10px] sm:text-xs font-mono text-muted-foreground"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-end sm:items-center gap-1 sm:gap-4 flex-none py-1">
            <div className="flex flex-col items-end sm:items-center gap-0.5">
              <span className="font-mono text-[8px] sm:text-[9px] text-muted-foreground/50 tracking-widest hidden sm:block">
                МАС. РАЗВАЛЬЩИК
              </span>
              <a
