    ...
    >
      ...
      <article className="mb-10">
        ...
        <div className="space-y-4 text-muted-foreground text-sm sm:text-base leading-relaxed">
          ...
          <p>
            Адрес: <strong className="text-foreground">Санкт-Петербург, шоссе Революции, 83</strong>. Режим работы: ежедневно 10:00–20:00. Телефон: <strong className="text-foreground">+7 (911) 747-80-57</strong>.
          </p>
        </div>
      </article>
