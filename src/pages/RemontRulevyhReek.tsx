    ...
    >
      ...
      <article className="mb-10">
        ...
        <div className="space-y-4 text-muted-foreground text-sm sm:text-base leading-relaxed">
          ...
          <p>
            В автосервисе <strong className="text-foreground">Азимут</strong> мы специализируемся на восстановительном ремонте рулевых реек — это позволяет сохранить оригинальный агрегат и сэкономить <strong className="text-foreground">до 70%</strong> по сравнению с покупкой новой или контрактной рейки. В процессе ремонта полностью разбираем рейку, дефектуем все детали, заменяем изношенные элементы ремонтным комплектом и проводим испытания под давлением.
          </p>
          <p>
          ...
          <p>
            Принимаем рейки как в сборе с тягами, так и отдельно. Срок ремонта: 1–3 рабочих дня в зависимости от сложности. Адрес: <strong className="text-foreground">Санкт-Петербург, шоссе Революции, 83</strong>.
          </p>
        </div>
      </article>
