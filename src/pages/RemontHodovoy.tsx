...
const FAQ = [
  {
    q: "Как понять, что пора ремонтировать ходовую часть?",
    a: "Основные признаки: стук или скрип при проезде неровностей, крен кузова в поворотах, вибрация руля на скорости, неравномерный износ шин. При любом из этих симптомов рекомендуем приехать на бесплатную диагностику.",
  },
  {
    q: "Сколько стоит диагностика ходовой части?",
    a: "Диагностика ходовой части бесплатна при заказе ремонта в нашем автосервисе. Мастер покажет на подъёмнике, что именно требует замены, и озвучит точную стоимость до начала работ.",
  },
  {
    q: "Нужно ли делать развал-схождение после ремонта ходовой?",
    a: "Да, обязательно. После замены рычагов, амортизаторов, сайлентблоков или шаровых опор геометрия подвески сбивается — регулировка углов на 3D-стенде входит в рекомендованный список работ.",
  },
  {
    q: "Какие запчасти вы используете?",
    a: "Работаем только с сертифицированными запчастями от проверенных поставщиков. На все работы и запчасти предоставляется гарантия.",
  },
  {
    q: "Сколько времени занимает ремонт ходовой части?",
    a: "Замена одного узла (амортизатор, шаровая, сайлентблок) занимает от 40 минут до 2 часов. Точный срок зависит от марки автомобиля и объёма работ — озвучим при диагностике.",
  },
];
...
export default function RemontHodovoy() {
  return (
    ...
    <ServicePageLayout
      ...
      subtitle="Диагностика и ремонт подвески любой сложности. Все марки автомобилей. Гарантия и качество всех видов работ и запчастей."
      price="от 1 500 ₽"
      relatedLinks={[
    ...
    >
      ...
      <article className="mb-10">
        ...
        <div className="space-y-4 text-muted-foreground text-sm sm:text-base leading-relaxed">
          ...
          <p>
            Мы находимся по адресу: <strong className="text-foreground">Санкт-Петербург, шоссе Революции, 83</strong>. Диагностика подвески — <strong className="text-foreground">бесплатно</strong> при заказе ремонта. <strong className="text-foreground">Гарантия и качество всех видов работ и запчастей.</strong>
          </p>
        </div>
      </article>
      ...
      <section className="mb-10">
        <h2 className="font-['Oswald'] text-xl sm:text-2xl font-bold uppercase tracking-tight mb-5">
          Частые вопросы о ремонте ходовой части
        </h2>
