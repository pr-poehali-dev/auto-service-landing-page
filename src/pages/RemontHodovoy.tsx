    ...
    >
      ...
      <article className="mb-10">
        ...
        <div className="space-y-4 text-muted-foreground text-sm sm:text-base leading-relaxed">
          ...
          <p>
            Мы находимся по адресу: <strong className="text-foreground">Санкт-Петербург, ул. Симонова, 15</strong>, заезд с Суздальского проспекта. Диагностика подвески — <strong className="text-foreground">бесплатно</strong> при заказе ремонта. <strong className="text-foreground">Гарантия и качество всех видов работ и запчастей.</strong>
          </p>
        </div>
      </article>
